    ...
    class Help : WindowSection
    {
        Dictionary<string, string[]> topics = new Dictionary<string, string[]>()
        {
            {"general", new string[] {
                ...
                "- five operators +, -, *, /, ^",
                "- constants: pi",
                "- functions: sin, cos, tan (tg), csc, sec, cot (ctg), asin, acos, atan, log",
                "",
                "$Commands:",
                "- 'he' help",
            ...
            {"functions", new string[] {
                ...
                "- 'log2'  returns the base 2 natural logarithm of a specified number.",
                "- 'log3'  returns the base 3 natural logarithm of a specified number.",
                "- 'log5'  returns the base 5 natural logarithm of a specified number.",
                "- 'log7'  returns the base 7 natural logarithm of a specified number.",
            ...
            {"variables", new string[] {
                ...
                "",
                "$Position:",
                "  Variables are displayed in the order of insertion. It is possible to move them",
                "  up and down in the list with the command 'mo'.",
                "",
                "$Results:",
